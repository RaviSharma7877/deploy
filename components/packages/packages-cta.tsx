      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-b from-[#15263F] via-[#122136] to-[#0D1A2C] px-6 py-16 text-center text-white sm:px-10 lg:px-16">
          ...
          <div className="relative mx-auto max-w-3xl">
            <h2 className="text-2xl font-semibold sm:text-3xl">Want a custom website or more features? Talk to us.</h2>
            <p className="mt-4 text-sm text-white/70 sm:text-base">
              Share the features you have in mind, the integrations you need, and we&apos;ll get back to you within 24 hours. Or,
              drop us your email and we&apos;ll take it from there.
            </p>
